...
int main()
{
	...
	struct SkillList SkillData[] = {
									 ...
									 {0,"核心摧毁★★☆"    ,2.6, 1, 7, 0, 13,  2, 30,"造成基础攻击260%的伤害"},
									 {0,"物质湮灭★★★"	,3.5, 1, 8, 0, 20,  3, 60,"造成基础攻击350%的伤害"}
									};
	...
	//分别为是否显示技能、技能名字、技能伤害计算数值、技能类型、技能CD、CDTime、技能消耗、技能等级、技能升级消耗、技能介绍
	struct SkillList SkillSptData[] = { 
										{0,"紧急包扎★☆☆"		,3 , 2, 7, 4, 6,  1, 8,"回复玩家3点生命值"},
										{0,"创伤修复★★☆"		,6 , 2, 8, 3, 10, 2, 18,"回复玩家6点生命值"},
										{0,"医疗机器★★★"		,10, 2, 8, 2, 15, 3, 40,"回复玩家10点生命值"},

										{0,"招架★☆☆"			,2 , 3 ,4, 2, 5, 1, 7,"防御，使受到的伤害降低2点"},
										{0,"能量盾★★☆"		,5 , 3 ,5, 2, 8, 2, 15,"防御，使受到的伤害降低5点"},
										{0,"防御立场★★★"		,8 , 3 ,5, 1, 10,3, 30,"防御，使受到的伤害降低8点"},

										{0,"分神★☆☆"				,8 ,4,6 ,3,0,1,6,"回复玩家8点耐力值"},
										{0,"伺机而动★★☆"			,14,4,8 ,2,0,2,10,"回复玩家14点耐力值"},
										{0,"运筹帷幄★★★"			,22,4,10,1,0,3,25,"回复玩家22点耐力值"},

										{0,"电击枪★☆☆"			,4,5,5,3,6 ,1,10 ,"造成基础攻击力40%的伤害，50%的概率眩晕敌人"},
	...
	struct Item item[] = { 
							{0,"血瓶"		,0 ,1 ,5 ,8 ,"回复8点生命值"},

							{0,"耐力药水"	,0 ,2 ,6 ,6 ,"回复6点耐力值"},

							{0,"能量护盾"	,0 ,3 ,3 ,6 ,"护盾值+6"},

							{0,"力量药水"	,0 ,4 ,4 ,6 ,"下回合额外伤害+6"}
						 };
	...
	//初始化玩家数据
	{
		PlayerData[0].PlayerExp = 190;					PlayerData[0].gold = 100;					PlayerData[0].PlayerLv = 1;
		PlayerData[0].PlayerMaxH = 10;					PlayerData[0].PlayerH = 10;					PlayerData[0].PlayerAtk = 2;
		PlayerData[0].PlayerName = "Player";			PlayerData[0].DiceNum = 10;					PlayerData[0].PlayerMaxSta = 10;
		PlayerData[0].PlayerStamina = 10;				PlayerData[0].DiceEf = 1;					PlayerData[0].ExDamage = 0;
		PlayerData[0].PlayerDef = 0;					PlayerData[0].IfFirstDead = 0;				PlayerData[0].SkillPoint = 200;
	}
